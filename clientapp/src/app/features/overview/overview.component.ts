...
import { IIntradayResponse, ITickerSummary, ITimeSeries, ITimeSeriesData } from '../../shared/interfaces/common-interfaces';
...
export class OverviewComponent implements OnInit, AfterViewInit {
  ...
  public currentETFs: Array<IIntradayResponse> = [];
  public currentETFsSummaries: Array<ITickerSummary> = [];

  // private commonETFs: Array<string> = [];
  // private commonETFs: Array<string> = ['VTI'];
  ...
  private getIntraday(): void {
    ...
    if (this.mockData && this.mockData.length) {
      ...
      this.currentETFsSummaries = this.mockData.map((response) => {
        const keys = Object.keys(response['Time Series (5min)']);
        const open = +response['Time Series (5min)'][keys[0]]['1. open'];
        const close = +response['Time Series (5min)'][keys[keys.length - 1]]['4. close'];
        const summary: ITickerSummary = {
          open: +open.toFixed(2),
          close: +close.toFixed(2),
          symbol: response['Meta Data']['2. Symbol'] ?? '',
          percentChange: this.findPercentChange(open, close),
        };
        return summary;
      });
    }
    ...
    //       console.log(this.currentETFsSummaries);
    //       this.currentsService.setCurrentTickerSummaries(this.currentETFsSummaries);
  ...
  private findPercentChange(num1: number, num2: number): number {
    ...
    return +((difference / average) * 100).toFixed(2);
  }

  // use this instead of using api calls
  public mockData: Array<IIntradayResponse> = [
    {
      "Meta Data": {
          "1. Information": "Intraday (5min) open, high, low, close prices and volume",
          "2. Symbol": "QQQ",
          "3. Last Refreshed": "2025-01-10 19:55:00",
          "4. Interval": "5min",
